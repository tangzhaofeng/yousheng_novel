...
class authorUserDao extends Dao{
	...
	private $fields_info = "user_id,name,sex,headPic,moneyCoin,up_time,subscribe";
	...
	public $table_gratuity_order = 'user_tip';
	private $fields_gratuity_order = "book_id,chapter_id,spare,create_time,playtime,user_id,disable,user_name,price";
	...
	public function insertUser($data){
		...
		$infodata['subscribe']=empty($data['subscribe'])?'':$data['subscribe'];
		unset($data['nickname']);
		unset($data['sex']);
		unset($data['headPic']);
