...
class qqInit {
	private $confing=array("appkey"=>"101326590","appsecretkey"=>"2370d59440d4b4c9d7f9a0063221587d","callback"=>"http://wap.manyuedu.cn");
	...
	private function get_access_token($code,$state){
		...
		setcookie("init_refresh_token",$params["refresh_token"],2419200,'/','wap.manyuedu.cn');
